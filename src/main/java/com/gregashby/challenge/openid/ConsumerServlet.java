package com.gregashby.challenge.openid;
...
public class ConsumerServlet extends javax.servlet.http.HttpServlet {
	...
	private void addSimpleRegistrationToAuthRequest(HttpServletRequest httpReq, AuthRequest authReq)
		...
		String[] attributes = { "nickname", "email", "fullname", "dob", "gender", "postcode", "country", "language",
				"timezone" };
	...
	Status API
	Training Shop
	Blog About©2016 GitHub,
	Inc.Terms Privacy
	Security Contact Help
}
